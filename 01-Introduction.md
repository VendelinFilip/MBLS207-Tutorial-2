...
Go through the text and follow the instructions. You are encouraged to work in small groups during the tutorial. Be careful with typing. We recommend not copy-pasting from this PDF: sometimes symbols or fonts will not copy well, and the command line will only interpret exactly the text you submit.
...
[https://dev.to/florianfelsing/how-to-run-an-ubuntu-vm-on-windows-11-4oef.](https://dev.to/florianfelsing/how-to-run-an-ubuntu-vm-on-windows-11-4oef.)
