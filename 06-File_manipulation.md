...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Next page</td>
      <td><code>/abc</code></td>
      <td>Search for text <code>abc</code></td>
    </tr>
    <tr>
      <td><code>b</code></td>
      <td>Back a page</td>
      <td><code>n</code></td>
      <td>Find next occurrence of <code>abc</code></td>
    </tr>
    <tr>
      <td><code>14g</code></td>
      <td>Go to line 14</td>
      <td><code>?</code> + <code>[Enter]</code></td>
      <td>Find previous occurrence of <code>abc</code></td>
    </tr>
    <tr>
      <td><code>G</code></td>
      <td>Go to end</td>
      <td><code>h</code></td>
      <td>Show help for <code>less</code></td>
    </tr>
  </tbody>
</table>
...
By default, `rm` does not remove directories. To remove `Temp2`, we can either remove all its contents and then remove the empty `Temp2` folder, or remove it with the `-R` argument (**r**ecursively) which will be faster. We will do the latter.
...
[Go to module 7](07-Handling_text_in_shell.md)
